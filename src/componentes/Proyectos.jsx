...
const Proyectos = () => {
    ...
    return (
        <section id="contenedorProyectos">
            ...
            <CarrouselProyectos idCarrousel={"carrouselCajitas"} titulo={idioma === "es" ? "Cajitas decoradas" : "Decorated boxes"} tituloDesc={idioma === "es" ? "Descripción" : "Description"} descripcion={idioma === "es" ? "Pagina responsive, de cajitas decoradas para un cliente." : "Responsive website about Home Decor items, for a client."} codigo={"https://github.com/RodrigoEzequielVazquez/"} img={<div className="carousel-inner"><div className="carousel-item active">

            ...
            <div>
...

                {
                    idioma === "es" ? <p> Comencé a estudiar programación en <Link to={"https://www.coderhouse.com/"} target="blank">Coder-House</Link>, una plataforma 100% digital. Completé la carrera de programador Full-stack, que se basaba en aprender HTML5 y CSS3, JavaScript aplicado al front-end, React.js y finalmente JavaScript aplicado desde el back-end. Por supuesto, todo esto estuvo acompañado de aprender muchas herramientas para el desarrollo como las que se pueden observar en el <Link to={"/"}>Inicio</Link>. <br />
                        ...
                        <br />
                        Actualmente, además, me encuentro estudiando en el mismo sitio un curso sobre Python y en paralelo un curso de PHP y MySQL en <Link to={"https://sceu.frba.utn.edu.ar/e-learning/"} target="blank">UTN</Link>.
                    </p> :

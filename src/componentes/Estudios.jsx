    ...
    return (
        <section id="contenedorEstudios">
            ...
            <div id="contenedorCursos">
                ...
                <Cursos curso={"Python"} id={"python"} certificado={"65cc004b254a6ed5f64eca7e"} aprendizaje={idioma === "es" ? "Entornos virtuales con Pipenv, Django, modelos, vistas y templates, gestionar usuarios, autenticación, registro y perfiles utilizando los módulos nativos de Django, contextos, formularios, mixins, CRUD, paginación, señales, managers, test." : "Virtual environments with Pipenv, Django, models, views and templates, manage users, authentication, registration and profiles using the native Django modules, contexts, forms, mixins, CRUD, pagination, signals, managers, tests."} />
